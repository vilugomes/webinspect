      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <li class="active"><a href="#">Ferramentas<span class="sr-only">(current)</span></a></li>
            <li><a href="consulta_dns_ip.html">Consulta DNS/IP</a></li>
            <li><a href="consulta_ip_dns.html">Consulta IP/DNS</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">        
          <h1 class="page-header">Consulta Memória</h1>         
...
<!-- <h3>Consulta DNS/IP</h3>
            <div class="row placeholders">
                

                <article id="dns">
                <input type="text" id="dns">
                <button id="action">Obter Endereço IP</button>
